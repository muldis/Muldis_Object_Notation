...
`Muldis_Object_Notation https://muldis.com 0.300.0`;
its part name is `Syntax_Plain_Blob`.
...
canonical concrete plain blob syntax of MUON,
...
The MUON `Syntax_Plain_Blob` is derived from and maps with the MUON
[Syntax_Abstract](Muldis_Object_Notation_Syntax_Abstract.md); see that plus
[Semantics](Muldis_Object_Notation_Semantics.md) for further context.

The MUON canonical plain blob format is semi-lightweight and designed to
...
The MUON `Syntax_Plain_Blob` exists as an alternative to the MUON
...
Blob parsing unit is `.muonblob`, though as per standard UNIX conventions,
