...
form based on *SYS_Pair_NA* to be portable.  If you use the nonqualified form,
...
Note that the fully-qualified (via *SYS_Pair_NA*) form of an **Integer**
...
* Any *SYS_Pair_NA* such that its *SYS_this* is the *SYS_Name* value `Text`
